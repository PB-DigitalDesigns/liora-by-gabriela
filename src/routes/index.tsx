...
function Hero() {
  return (
   <section id="top" className="relative pt-28 sm:pt-32 lg:pt-36">
     <BotanicalBg />
      <div className="relative mx-auto grid max-w-7xl grid-cols-1 items-center gap-10 px-5 pb-6 sm:px-8 lg:grid-cols-2 lg:gap-16 lg:pb-10">
...
function Projects() {
  return (
    <section id="projects" className="pt-8 sm:pt-14">
